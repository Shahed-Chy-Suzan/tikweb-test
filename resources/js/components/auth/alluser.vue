              ...
              <table class="table table-striped table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <tr v-for="allUser in allUsers" :key="allUser.id">
                    ...
                    <td v-if="allUser.user_role == 0" class="fontSize">Admin </td>
                    <td v-if="allUser.user_role == 1" class="fontSize">Moderator </td>
                    <td v-if="allUser.user_role == 2" class="fontSize">Editor </td>
                  </tr>
                </tbody>
              </table>
          </div>
